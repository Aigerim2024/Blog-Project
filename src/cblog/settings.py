...
DATABASES = {
    'default': {
        ...
        'NAME': 'database-15', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'admin12345',
        'HOST': 'database-15.clyqmsce414q.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'lastbucket-1' # please enter your s3 bucket name
